...
- RSA and hash triage are structured; known-factor, low-exponent exact-root, and common-modulus RSA now preserve parameters, recover flags when directly solvable, and emit reproducible Python solve scripts in the Write-up.
