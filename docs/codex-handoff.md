...
- Local Web UI:
  ...
  - Pwn challenges show a local environment panel with Docker/Kali entry, `socat` service launch, triage commands, and a one-click local Target/Active probe helper
